...
class H266Transport {
    constructor(client, stream, details) {
        this.has_donl = false; // We have to check the SDP to see if DONL bytes are being set in the RTP packet
        this.rtpPackets = [];
        this.client = client;
        this.stream = stream;
    ...
    processConnectionDetails(details) {
        ...
        const dci = ('sprop-dci' in fmtpConfig) ? Buffer.from((_a = fmtpConfig['sprop-dci']) === null || _a === void 0 ? void 0 : _a.toString(), "base64") : null;
        const vps = ('sprop-vps' in fmtpConfig) ? Buffer.from((_b = fmtpConfig['sprop-vps']) === null || _b === void 0 ? void 0 : _b.toString(), "base64") : null;
        const sps = ('sprop-sps' in fmtpConfig) ? Buffer.from((_c = fmtpConfig['sprop-sps']) === null || _c === void 0 ? void 0 : _c.toString(), "base64") : null;
        const pps = ('sprop-pps' in fmtpConfig) ? Buffer.from((_d = fmtpConfig['sprop-pps']) === null || _d === void 0 ? void 0 : _d.toString(), "base64") : null;
        if (dci != null) {
...
exports.default = H266Transport;
//# sourceMappingURL=H266Transport.js.map