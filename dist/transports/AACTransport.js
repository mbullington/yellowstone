...
class AACTransport {
    ...
    processRTPPacket(packet) {
        ...
        while (true) {
            ...
            const au_headers_length_bits = (rtp_payload[ptr] << 8) + (rtp_payload[ptr + 1] << 0); // 16 bits
        ...
        for (let x = 0; x < audio_data.length; x++) {
            ...
            const bs = new util_1.BitStream(); //TODO - we could cache the header bitstream
